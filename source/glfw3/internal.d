...
// APIENTRY
alias PFNGLCLEARPROC = extern(Windows) void function(GLbitfield);
alias PFNGLGETSTRINGPROC = extern(Windows) const(GLubyte)* function(GLenum);
alias PFNGLGETINTEGERVPROC = extern(Windows) void function(GLenum, GLint*);
alias PFNGLGETSTRINGIPROC = extern(Windows) const(GLubyte)* function(GLenum, GLuint);
...
version(_GLFW_VULKAN_STATIC) {
  ...
  alias PFN_vkGetInstanceProcAddr = PFN_vkVoidFunction function(VkInstance,const(char)*);
...
enum _GLFW_VERSION_NUMBER =
    GLFW_VERSION_MAJOR.stringof ~ "." ~ GLFW_VERSION_MINOR.stringof ~ "." ~ GLFW_VERSION_REVISION.stringof;
...
void _GLFW_SWAP_POINTERS(T, U)(ref T x, ref U y) {
    auto t = x;
    x = y;
    y = t;
}
...
struct _GLFWwndconfig
{
    ...
    struct _Ns{
        GLFWbool retina;
        char[256] frameName = '\0';
    }_Ns ns;
    struct _X11{
        char[256] className = '\0';
        char[256] instanceName = '\0';
    }_X11 x11;
}
...
struct _GLFWcontext
{
    ...
    mixin _GLFW_PLATFORM_CONTEXT_STATE;
    // This is defined in egl_context.h
    mixin _GLFW_EGL_CONTEXT_STATE;
    // This is defined in osmesa_context.h
    mixin _GLFW_OSMESA_CONTEXT_STATE;
}
...
struct _GLFWwindow
{
    ...
    mixin _GLFW_PLATFORM_WINDOW_STATE;
}
...
struct _GLFWmonitor
{
    ...
    // This is defined in the window API's platform.h
    mixin _GLFW_PLATFORM_MONITOR_STATE;
}
...
struct _GLFWcursor
{
    ...
    // This is defined in the window API's platform.h
    mixin _GLFW_PLATFORM_CURSOR_STATE;
}
...
struct _GLFWjoystick
{
    ...
    mixin _GLFW_PLATFORM_JOYSTICK_STATE;
}
...
struct _GLFWtls
{
    ...
    mixin _GLFW_PLATFORM_TLS_STATE;
}
...
struct _GLFWlibrary
{
    ...
    struct _Timer{
        ...
        mixin _GLFW_PLATFORM_LIBRARY_TIMER_STATE;
    }_Timer timer;
...
version(Windows) {
    ...
    // This is defined in the window API's platform.h
    mixin _GLFW_PLATFORM_LIBRARY_WINDOW_STATE;
    // This is defined in the context API's context.h
    mixin _GLFW_PLATFORM_LIBRARY_CONTEXT_STATE;
    // This is defined in the platform's joystick.h
    mixin _GLFW_PLATFORM_LIBRARY_JOYSTICK_STATE;
    // This is defined in egl_context.h
    mixin _GLFW_EGL_LIBRARY_CONTEXT_STATE;
    // This is defined in osmesa_context.h
    mixin _GLFW_OSMESA_LIBRARY_CONTEXT_STATE;
}
